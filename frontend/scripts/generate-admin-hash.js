/**
 * Generate SHA-256 hash for admin password. Use in frontend/.env as VITE_ADMIN_PASSWORD_HASH.
 * Run from frontend folder: node scripts/generate-admin-hash.js "yourPassword"
 */
