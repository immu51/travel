  ...
  return (
    <section id="why-choose" className="py-20 md:py-28 bg-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <GSAPAnimateIn variant="fadeUpStrong" className="text-center mb-2">
        ...
        <GSAPAnimateIn variant="fadeUpScale" stagger={0.1} staggerChildren=".why-card" className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {cards.map(({ icon, title, text }) => (
            <article key={title} className="why-card card-glass card-premium card-shine rounded-card p-6 lg:p-8 h-full">
