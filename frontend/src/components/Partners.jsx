    ...
    <section className={`${SECTION_PADDING} bg-bg`}>
      <div className={CONTAINER_CLASS}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {partners.map((item, i) => (
            <AnimateIn key={item.name} variant="fadeUpScale" delay={100 + i * 60}>
              <div className="rounded-2xl bg-white border border-primary/10 shadow-soft p-6 text-center hover:shadow-glass transition-shadow duration-300">
