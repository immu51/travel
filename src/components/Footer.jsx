...
const QUICK_LINKS = [
  ...
  { href: '#packages', label: 'Adventure Trips' },
  { href: '#contact', label: `Travel Agency in ${CITY_NAME}` },
]
      ...
      <div className={CONTAINER_CLASS}>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-white/80 text-sm">{ADDRESS_SHORT}</p>
          ...
          <div>
            ...
            <form onSubmit={handleNewsletter} className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2.5 rounded-card text-primary text-sm outline-none focus:ring-2 focus:ring-accent"
              />
              <button
                type="submit"
                className="bg-accent text-primary font-semibold px-4 py-2.5 rounded-card hover:bg-[#e8914a] transition-colors text-sm"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-white/10">
          <p className="text-white/60 text-sm">© 2025 TravelIndia. All rights reserved.</p>
          <div className="flex gap-4">
            <a href="#" onClick={(e) => e.preventDefault()} className="text-white/70 hover:text-accent transition-colors" aria-label="Facebook">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
              </svg>
            </a>
            <a href="#" onClick={(e) => e.preventDefault()} className="text-white/70 hover:text-accent transition-colors" aria-label="Instagram">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href={whatsappUrl()} target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-accent transition-colors" aria-label="WhatsApp">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
